export const products = [
  {
    ...
    badge: "Bestseller",
    description: "A silky, non-foaming cream cleanser that melts away makeup and impurities while preserving the delicate acid mantle. Infused with oat silk and ceramides.",
    ingredients: "Water, Glycerin, Ceramide NP, Oat Amino Acids, Panthenol.",
    howToUse: "Massage onto damp skin in circular motions. Rinse with lukewarm water. Use AM and PM."
  },
  {
    id: "luminous-c-essence",
    name: "Luminous C 15% Essence",
    category: "Step 2 — Treat",
    price: 289000,
    ...
    badge: "New Release",
    description: "A potent 15% L-Ascorbic Acid serum stabilized with Ferulic Acid and Vitamin E. Rapidly fades dark spots and provides environmental defense.",
    ingredients: "Water, Ascorbic Acid, Ethoxydiglycol, Propylene Glycol, Ferulic Acid, Tocopherol.",
  ...
  },
  {
    ...
    rating: 4.7,
    reviews: 210,
    image: "https://images.unsplash.com/photo-1615397323288-75c1363e18cf?auto=format&fit=crop&w=800&q=80",
    description: "Our signature whipped cream moisturizer that locks in hydration for 48 hours without feeling heavy. Ideal for compromised barriers.",
    ingredients: "Water, Squalane, Niacinamide, Shea Butter, Ceramide AP, Ceramide EOP.",
  ...
  },
  {
    ...
    rating: 4.9,
    reviews: 312,
    image: "https://images.unsplash.com/photo-1556228578-8d89b6acd8d4?auto=format&fit=crop&w=800&q=80",
    badge: "Award Winner",
    description: "An invisible, weightless sunscreen that leaves zero white cast. Acts as a gripping primer under makeup while providing maximum UV protection.",
    ingredients: "Water, Homosalate, Octocrylene, Ethylhexyl Salicylate, Silica, Butylene Glycol.",
